...
/*
	...
	//Front face
	polygons.push_back(new Triangle(frontLeft,frontLeft + right(d),frontLeft + up(d),mat));
	polygons.push_back(new Triangle(frontLeft+right(d),frontLeft+right(d)+up(d),frontLeft+up(d),mat));
	//Left face
	polygons.push_back(new Triangle(frontLeft, frontLeft + far(d) + up(d),frontLeft + far(d),mat));
	polygons.push_back(new Triangle(frontLeft,frontLeft + up(d),frontLeft + far(d) + up(d),mat));
	//Back face
	polygons.push_back(new Triangle(backRight, backRight + left(d) + down(d),backRight + left(d),mat));
	polygons.push_back(new Triangle(backRight,backRight + down(d), backRight + down(d) + left(d),mat));
	//Right face
	polygons.push_back(new Triangle(backRight, backRight + down(d) + near(d),backRight + down(d),mat));
	polygons.push_back(new Triangle(backRight,backRight + near(d), backRight + down(d) + near(d),mat));
	//Top face
	polygons.push_back(new Triangle(backRight,backRight + left(d), backRight + left(d) + near(d),mat));
	polygons.push_back(new Triangle(backRight, backRight + near(d) + left(d),backRight + near(d),mat));
	//Bottom face
	polygons.push_back(new Triangle(frontLeft,frontLeft + far(d),frontLeft + far(d) + right(d),mat));
	polygons.push_back(new Triangle(frontLeft, frontLeft + right(d) + far(d),frontLeft + right(d),mat));
	*/